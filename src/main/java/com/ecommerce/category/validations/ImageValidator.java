...
import com.ecommerce.category.exceptions.ValidateException;
...
public class ImageValidator {
    ...
    public void validateCreate(MultipartFile file) {
        if (file == null || file.isEmpty()) {
            ...
            throw new ValidateException("La imagen es obligatoria al crear una categoría.");
        }
    ...
    public void validateCommomRules(MultipartFile file){
        ...
        if (contentType == null ||
            ...
            throw new ValidateException("Solo se permiten imagenes JPEG, JPG o PNG.");
        }

        if (file.getSize() > MAX_SIZE) {
            log.error("La imagen no debe superar los 2 MB.");
            throw new ValidateException("La imagen no debe superar los 2 MB.");
        }
    }
}
